    ...
    <section class="car">
        <div class="container">
            ...
            while ($row = mysqli_fetch_array($result)) {
                ?>
            <h1>Ваш выбор пал на
                <?echo($row["brand"]." - ".$row["model"]) ?> за
                <?echo($row["price"]);?> рублей
            </h1>
            <img src="img/<? echo $row["img"]?>" alt="">
            <div class="car__title">Характеристики автомобиля</div>
            <ul class="car__specifications">
                <li>марка -
                    <?echo $row["brand"]?>
                </li>
                <li>модель -
            ...
            <?}?>
            <h1>оставьте ваши контактные данные, мы с вами свяжемся</h1>
            <div class="form__wrapper">
                <form class="car__form">
                    <label>ваше имя</label>
                    <input type="text" class="car__form-input">
                    <label>ваше номер телефона</label>
                    <input type="text" class="car__form-input">
                    <button class="car__form-btn" type="button">Отправить</button>
                </form>
            </div>
