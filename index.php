...
<body>
    ...
    <section class="slider__section">
        <div class="slider">
            ...
            <div class="slider__item">
                <img src="img/kopeika.jpg" alt="">
                <div class="slider__item-content">
                    <div class="slider__item-title">Lorem ipsum dolor sit amet.</div>
                    <div class="slider__item-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. A, sequi.
                    </div>
                    <div class="slider__item-btn">Подобрать</div>
                </div>
            </div>

            <div class="slider__item">
                <img src="img/semaga.jpg" alt="">
                <div class="slider__item-content">
                    <div class="slider__item-title">Lorem ipsum dolor sit amet.</div>
                    <div class="slider__item-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. A, sequi.
                    </div>
            ...
            <div class="slider__item">
                <img src="img/shaxa.jpg" alt="">
                <div class="slider__item-content">
                    <div class="slider__item-title">Lorem ipsum dolor sit amet.</div>
                    <div class="slider__item-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. A, sequi.
                    </div>
                    <a class="slider__item-btn" href="#">Подобрать <i></i></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="reviews">
        <div class="container">
            <h1 class="review__title">Отзывы о нашем автосалоне</h1>
            <?php
